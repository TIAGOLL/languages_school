      ...
      <div className='flex flex-row mt-1'>
        ...
        <div className='flex w-full justify-center items-center'>
          <Tabs value={activeTab} onValueChange={handleTab} defaultValue="all" className="w-[calc(100vw-135px)] mt-5 justify-center items-center flex flex-col">
            ...
            <TabsContent value="all" className="w-[calc(100vw-140px-150px)] mt-10 justify-center flex flex-col">
              <DataTableRegistrations />
            </TabsContent>
            <TabsContent value="create" className="w-[calc(100vw-140px-150px)] mt-10 justify-center flex">
              <CreateRegistration />
            </TabsContent>
          </Tabs>
        </div>
