...
function BookViewer({ book, lesson }) {
  ...
  async function GetUrlLesson() {
    const urlLesson = await axios.get(`${import.meta.env.VITE_REACT_BASE_API_URL}/book/getLessons/${book}/${lesson}`)
    return setUrlLesson(urlLesson.data?.url)
  }
