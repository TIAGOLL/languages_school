    ...
    <div className='mt-10 flex flex-col w-[1000px]'>
      <form onSubmit={handleSubmit(updateStudent)} className='grid grid-cols-8 gap-2'>
        ...
        <div className='col-span-4'>
          <Label>ID</Label>
          <Input placeholder="ID" {...register('id', { valueAsNumber: true })} disabled />
        ...
        <div className='col-span-4'>
          <Label>CPF</Label>
          <Input placeholder="CPF" {...register('cpf')} disabled />
        ...
        <div className='col-span-4'>
          <Label>Usuário</Label>
          <Input placeholder="Usuário" {...register('user')} disabled />
