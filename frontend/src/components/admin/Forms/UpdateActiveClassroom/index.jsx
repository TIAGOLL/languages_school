...
import { useUpdateActiveClassroomForm } from "./useUpdateActiveClassroomForm";
import { useEffect } from "react";

export function UpdateActiveClassroomForm({ data }) {

  const { register, setValue, handleSubmit, updateClassroom, errors, watch } = useUpdateActiveClassroomForm()
